      ...
      <div className="rgpd-container">
        ...
        <div className="rgpd-content">
          <p>
            ...
            Chez Speaker's Corner, nous accordons une grande importance à la
          ...
          <p>
            1 - Collecte des données personnelles :<br/>
          ...
          <p>
            2 - Utilisation des données personnelles : <br />
          ...
          <p>
            3 - Protection des données personnelles :<br /> Nous prenons des mesures
          ...
          <p>
            4 - Partage des données personnelles :<br /> Nous ne vendons,
          ...
          <p>
            5 - Cookies et technologies similaires :<br /> Nous utilisons des
